...
import acneBlemishesImage from '../src/assets/Acne&Blemishes.jpg';
import antiAgingImage from '../src/assets/againg.jpg';
import darkSpotsImage from '../src/assets/darkspots.jpg';
import oilySkinImage from '../src/assets/oilyskin.jpg';
import drySkinImage from '../src/assets/dryskin.jpg';
import sensitiveSkinImage from '../src/assets/sensitiveskin.jpg';
...
export default function HomePage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {skinConcerns.map((concern, index) => (
              <SkinConcernCard key={index} title={concern.title} description={concern.description} image={concern.image} productCount={concern.productCount} />
            ))}
          </div>
        </div>
      </section>
      ...
      <section id="chocolate" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl mb-4">Chocolate</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Premium chocolates from world-famous brands
            </p>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6">
            {[
              { name: 'Ferrero', image: 'https://images.unsplash.com/photo-1606312619070-d48b4e6e5c8e?w=400&h=400&fit=crop&q=80' },
              { name: 'Fazer', image: 'https://images.unsplash.com/photo-1606312619070-d48b4e6e5c8e?w=400&h=400&fit=crop&q=80' },
              { name: 'Kit Kat', image: 'https://images.unsplash.com/photo-1606312619070-d48b4e6e5c8e?w=400&h=400&fit=crop&q=80' },
              { name: 'Marabou', image: 'https://images.unsplash.com/photo-1606312619070-d48b4e6e5c8e?w=400&h=400&fit=crop&q=80' },
              { name: 'Lindt', image: 'https://images.unsplash.com/photo-1606312619070-d48b4e6e5c8e?w=400&h=400&fit=crop&q=80' },
            ].map((brand) => (
              <Link key={brand.name} href="/shop" className="group">
                <div className="bg-white rounded-xl p-6 border border-gray-100 hover:border-primary/30 hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <div className="aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
      ...
      {/* Nutella Section */}
      <section id="nutella" className="py-20 bg-gradient-to-br from-amber-50 to-orange-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <p className="text-sm uppercase tracking-widest text-primary mb-3">Specialty</p>
            <h2 className="text-4xl mb-4">Nutella</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              The world's favorite hazelnut spread
            </p>
          </div>
          <div className="flex justify-center">
            <Link href="/shop" className="group">
              <div className="bg-white rounded-xl p-8 border border-gray-100 hover:border-primary/30 hover:shadow-lg transition-all duration-300 cursor-pointer max-w-xs">
                <div className="aspect-square rounded-lg overflow-hidden bg-gray-100 mb-4">
                  <img src="https://images.unsplash.com/photo-1606312619070-d48b4e6e5c8e?w=400&h=400&fit=crop&q=80" alt="Nutella" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                </div>
                <div className="text-center text-lg font-medium text-foreground group-hover:text-primary transition-colors">
                  Nutella
                </div>
              </div>
            </Link>
